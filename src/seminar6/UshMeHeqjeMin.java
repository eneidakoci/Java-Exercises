...
the lowest score. The program uses arrays.  10 4 7 8 5.5 6 kthen shumen 36.5 (shuma pa 4-en)
*/
public class UshMeHeqjeMin
{
...
{
// Grow the array if it has been completely filled290 Chapter 6 Arrays and Array Lists
